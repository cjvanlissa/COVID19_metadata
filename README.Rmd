...
A collection of relevant country/city level metadata about the COVID-19 pandemic, made interoperable for secondary analysis. Curated by [Data scientists Against Corona](https://dataversuscorona.com/), collaborators: *Caspar van Lissa*, *Tim Draws*, *Andrii Grygoryshyn*, and *Konstantin Tomić*.
...
dat <- structure(list(
  Category = c("Risk level", "Risk level", "Policies", "Preparedness", "Preparedness", "Preparedness", "COVID19", "Economic"),
  Information = c("Hospital data per country", "Health infrastructure per country data", "Tracking global response to covid19 database", "Pandemic preperadness score data", "GHS index database ", "Health security database", "Number of cases and fatalities", "World Development Indicators"),
  Source = c("WHO Health workforce/facilities database", "OECD Health care resources database", "Oxford Tracker for Regulation Policies", "GHS index", "GHS Index", "GHS index", "CSSE Global Cases", "World Bank"), 
    URL = c("https://apps.who.int/gho/data/node.main.HWF", "https://stats.oecd.org/index.aspx?queryid=30183", 
    "https://www.bsg.ox.ac.uk/research/research-projects/oxford-covid-19-government-response-tracker", 
    "https://www.ghsindex.org/", "https://www.ghsindex.org/", 
    "https://www.ghsindex.org/", "https://github.com/CSSEGISandData/COVID-19",
    "https://datacatalog.worldbank.org/dataset/world-development-indicators"),
  Progress = c("In progress", "In progress", "Done", "Done", "Done", "Done", "Done", "Done")), class = "data.frame", row.names = c(NA, -8L))
